<template>
  ...
  <div
    class="modal fade"
    ref="newPenerbanganModalRef"
    id="kt_add_modal_penerbangan"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Add Data Penerbangan</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-7 px-lg-17">
            ...
            <div
              ...
              id="kt_add_modal_penerbangan_scroll"
            >
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <Field name="jenis_pesawat" v-slot="{ value, field, errorMessage }">
                        ...
                        <el-col :span="12">
                            <Field name="bahan_bakar" v-slot="{ value, field, errorMessage }">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <Field name="jam_terbang" type="number" v-slot="{ value, field, errorMessage }">
                        ...
                        <el-col :span="12">
                            <Field name="konsumsi_bahan_bakar" type="number" v-slot="{ value, field, errorMessage }">
...
export default {
    ...
    methods: {
        async onSubmit(values, actions) {
            ...
            await axios.post('/api/penerbangan/add',values).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_add_modal_penerbangan').modal('hide');
                        actions.resetForm();
                    });
                  }else{
                    Swal.fire({
