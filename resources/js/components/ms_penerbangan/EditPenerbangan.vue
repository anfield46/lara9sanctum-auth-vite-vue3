<template>
  ...
  <div
    class="modal fade"
    ref="editPenerbanganModalRef"
    id="kt_edit_modal_penerbangan"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Edit Data Penerbangan</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-7 px-lg-17">
            ...
            <div
              ...
              id="kt_edit_modal_penerbangan_scroll"
            >
                
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <Field name="tahun" type="select" v-model="penerbangan.tahun" v-slot="{ value, field, errorMessage }">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <Field name="jenis_pesawat" v-model="penerbangan.jenis_pesawat" v-slot="{ value, field, errorMessage }">
                            <el-form-item :error="errorMessage" label="Jenis Pesawat" required>
                                <el-input
                                placeholder="0"
                                v-bind="field"
                        ...
                        <el-col :span="12">
                            <Field name="bahan_bakar" v-model="penerbangan.bahan_bakar" v-slot="{ value, field, errorMessage }">
                            <el-form-item :error="errorMessage" label="Bahan Bakar" required>
                                <el-input
                                placeholder="0"
                                v-bind="field"
                                :validate-event="false"
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <Field name="jam_terbang" v-model="penerbangan.jam_terbang" v-slot="{ value, field, errorMessage }">
                            <el-form-item :error="errorMessage" label="Jam Terbang" required>
                                <el-input
                                placeholder="0"
                                v-bind="field"
                                :validate-event="false"
                        ...
                        <el-col :span="12">
                            <Field name="konsumsi_bahan_bakar" v-model="penerbangan.konsumsi_bahan_bakar" v-slot="{ value, field, errorMessage }">
                            <el-form-item :error="errorMessage" label="Konsumsi Bahan Bakar" required>
                                <el-input
                                placeholder="0"
                                v-bind="field"
                                :validate-event="false"
...
export default {
    ...
    setup() {
        const schema = yup.object({
            ...
            jenis_pesawat: yup.string().required().label('Jenis Pesawat'),
            bahan_bakar: yup.string().required().label('Bahan Bakar'),
    ...
    watch: {
        detailpenerbangan: {
            handler(val, old) {
                this.penerbangan.id = val.id;
                this.penerbangan.tahun = val.tahun;
                this.penerbangan.jenis_pesawat = val.jenis_pesawat;
                this.penerbangan.bahan_bakar = val.bahan_bakar;
    ...
    methods: {
        async onSubmit(values, actions) {
            ...
            await axios.post(`/api/penerbangan/update/${this.penerbangan.id}`,values).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_edit_modal_penerbangan').modal('hide');
                        actions.resetForm();
                    });
                  }else{
                    Swal.fire({
