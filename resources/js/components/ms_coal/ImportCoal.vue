    ...
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Import Data Coal</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_import_modal_coal_scroll"
            >
              <!--begin::Input group-->
...
export default {
    ...
    methods: {
        async submit() {
            ...
            formData.append('file', this.coal.file);

            await axios.get('/sanctum/csrf-cookie')
            await axios.post('/api/coal/import',formData).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_import_modal_coal').modal('hide');
        ...
        handleFileUpload(){
          this.coal.file = this.$refs.file.files[0];
        }
    }
}
</script>
