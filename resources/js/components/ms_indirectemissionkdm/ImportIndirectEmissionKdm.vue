<template>
  ...
  <div
    ...
    id="kt_import_modal_indirectemissionkdm"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Import Data Indirect Emission KDM</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_import_modal_indirectemissionkdm_scroll"
            >
              <!--begin::Input group-->
...
export default {
    ...
    methods: {
        async submit() {
            ...
            formData.append('file', this.indirectemissionkdm.file);

            await axios.get('/sanctum/csrf-cookie')
            await axios.post('/api/indirectemissionkdm/import',formData).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_import_modal_indirectemissionkdm').modal('hide');

                        this.indirectemissionkdm.file = '';
                    });
                  }else{
                    Swal.fire({
                        text: response.data['message'],
        ...
        handleFileUpload(){
          this.indirectemissionkdm.file = this.$refs.file.files[0];
        }
    }
}
</script>
