<template>
  ...
  <div
    class="modal fade"
    ref="newDaratGasolineModalRef"
    id="kt_add_modal_darat_gasoline"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Add Data Darat Gasoline</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-7 px-lg-17">
            ...
            <div
              ...
              id="kt_add_modal_darat_gasoline_scroll"
            >
...
export default {
    ...
    methods: {
        async onSubmit(values, actions) {
            ...
            await axios.post('/api/daratgasoline/add',values).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_add_modal_darat_gasoline').modal('hide');
                        actions.resetForm();
                    });
                  }else{
                    Swal.fire({
