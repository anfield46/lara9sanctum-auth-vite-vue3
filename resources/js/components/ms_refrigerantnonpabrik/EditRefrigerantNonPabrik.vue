<template>
  ...
  <div
    class="modal fade"
    ref="editRefrigerantNonPabrikModalRef"
    id="kt_edit_modal_refrigerantnonpabrik"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Edit Data Refrigerant Non Pabrik</h2>
                <!--end::Modal title-->
...
export default {
    ...
    props: ["detailrefrigerantnonpabrik"],
    data() {
        return {
            loading:false,
            value:"tes",
    ...
    methods: {
        async onSubmit(values, actions) {
            ...
            await axios.post(`/api/refrigerantnonpabrik/update/${this.refrigerantnonpabrik.id}`,values).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_edit_modal_refrigerantnonpabrik').modal('hide');
                        actions.resetForm();
                    });
                  }else{
                    Swal.fire({
