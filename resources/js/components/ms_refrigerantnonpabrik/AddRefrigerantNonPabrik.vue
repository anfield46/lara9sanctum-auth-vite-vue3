<template>
  ...
  <div
    class="modal fade"
    ref="newRefrigerantNonPabrikModalRef"
    id="kt_add_modal_refrigerantnonpabrik"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Add Data Refrigerant Non Pabrik</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-7 px-lg-17">
            ...
            <div
              ...
              id="kt_add_modal_refrigerantnonpabrik_scroll"
            >
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="12">
                            <Field name="amount_botol" type="number" v-slot="{ value, field, errorMessage }">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <Field name="amount_kg_botol" type="number" v-slot="{ value, field, errorMessage }">
                        ...
                        <el-col :span="12">
                            <Field name="amount_kg" type="number" v-slot="{ value, field, errorMessage }">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <Field name="operating_emission" type="number" v-slot="{ value, field, errorMessage }">
...
export default {
    ...
    methods: {
        async onSubmit(values, actions) {
            ...
            await axios.post('/api/refrigerantnonpabrik/add',values).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_add_modal_refrigerantnonpabrik').modal('hide');
                        actions.resetForm();
                    });
                  }else{
                    Swal.fire({
