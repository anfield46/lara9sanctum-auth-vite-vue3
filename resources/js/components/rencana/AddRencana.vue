<template>
  ...
  <div
    class="modal fade"
    ref="newGasAlamModalRef"
    id="kt_add_modal_rencana"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Add Data Rencana</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-7 px-lg-17">
            ...
            <div
              ...
              id="kt_add_modal_rencana_scroll"
            >
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            ...
                            <el-form-item :error="errorMessage" label="Tahun" required>
                                <el-select v-bind="field" :validate-event="true" :model-value="value" filterable placeholder="Select" style="width:100%">
                                <el-option
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="12">
                            <Field name="program_net_zero" type="select" v-slot="{ value, field, errorMessage }">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <Field name="rencana_pengurangan_emisi" type="number" v-slot="{ value, field, errorMessage }">
                            <el-form-item :error="errorMessage" label="Rencana Pengurangan Emisi" required>
                                <el-input
                                placeholder="0"
                                v-bind="field"
                        ...
                        <el-col :span="12">
                            <Field name="rencana_penambahan_emisi" type="number" v-slot="{ value, field, errorMessage }">
                            <el-form-item :error="errorMessage" label="Rencana Penambahan Emisi" required>
                                <el-input
                                placeholder="0"
                                v-bind="field"
                                :validate-event="false"
...
export default {
    ...
    setup() {
        const schema = yup.object({
            ...
            program_net_zero: yup.string().required().label('Program Net Zero'),
            rencana_pengurangan_emisi: yup.number().required().label('Rencana Pengurangan Emisi'),
            rencana_penambahan_emisi: yup.number().required().label('Rencana Penambahan Emisi'),
            });
        return {
            schema,
        };
    ...
    methods: {
        async onSubmit(values, actions) {
            ...
            await axios.post('/api/rencana/add',values).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_add_modal_rencana').modal('hide');
                        actions.resetForm();
                    });
                  }else{
                    Swal.fire({
