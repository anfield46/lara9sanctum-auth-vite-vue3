<template>
  ...
  <div
    class="modal fade"
    ref="newImportIppuModalRef"
    id="kt_import_modal_ippu"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Import Data Ippu</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_import_modal_ippu_scroll"
            >
              <!--begin::Input group-->
...
export default {
    ...
    methods: {
        async submit() {
            ...
            formData.append('file', this.ippu.file);

            await axios.get('/sanctum/csrf-cookie')
            await axios.post('/api/ippu/import',formData).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_import_modal_ippu').modal('hide');
        ...
        handleFileUpload(){
          this.ippu.file = this.$refs.file.files[0];
        }
    }
}
</script>
