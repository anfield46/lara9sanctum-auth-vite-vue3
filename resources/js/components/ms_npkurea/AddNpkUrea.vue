<template>
  ...
  <div
    class="modal fade"
    ref="newNpkUreaModalRef"
    id="kt_add_modal_npkurea"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Add Data Npk & Urea</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-7 px-lg-17">
            ...
            <div
              ...
              id="kt_add_modal_npkurea_scroll"
            >
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="12">
                            <Field name="jenis" type="select" v-slot="{ value, field, errorMessage }">
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="12">
                            <Field name="emission_factor" type="number" v-slot="{ value, field, errorMessage }">
...
export default {
    ...
    methods: {
        async onSubmit(values, actions) {
            ...
            await axios.post('/api/npkurea/add',values).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_add_modal_npkurea').modal('hide');
                        actions.resetForm();
                    });
                  }else{
                    Swal.fire({
