<template>
  ...
  <div
    class="modal fade"
    ref="newDistribusiKapalModalRef"
    id="kt_add_modal_distribusikapal"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Add Data Distribusi Kapal</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-7 px-lg-17">
            ...
            <div
              ...
              id="kt_add_modal_distribusikapal_scroll"
            >
                    ...
                    <el-row :gutter="20">
                        <el-col :span="7">
                            <Field name="consumption_liter" type="number" v-slot="{ value, field, errorMessage }">
                        ...
                        <el-col :span="7">
                            <Field name="consumption_tj" type="number" v-slot="{ value, field, errorMessage }">
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="12">
                            <Field name="n2o_emission" type="number" v-slot="{ value, field, errorMessage }">
                            <el-form-item :error="errorMessage" label="N2O Emission" required>
                                <el-input
                                placeholder="0"
                                v-bind="field"
                                :validate-event="false"
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="12">
                            <Field name="kg_co2eq" type="number" v-slot="{ value, field, errorMessage }">
                            <el-form-item :error="errorMessage" label="Kg CO2eq" required>
                                <el-input
                                placeholder="0"
                                v-bind="field"
                                :validate-event="false"
...
export default {
    ...
    setup() {
        const schema = yup.object({
            ...
            consumption_liter: yup.number().required().label('Consumption Liter'),
            ...
            n2o_emission: yup.number().required().label('N2O Emission'),
            ton_co2eq: yup.number().required().label('ton_CO2eq'),
            kg_co2eq: yup.number().required().label('kg_CO2eq'),
            });
        return {
            schema,
        };
    ...
    methods: {
        async onSubmit(values, actions) {
            ...
            await axios.post('/api/distribusikapal/add',values).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_add_modal_distribusikapal').modal('hide');
                        actions.resetForm();
                    });
                  }else{
                    Swal.fire({
