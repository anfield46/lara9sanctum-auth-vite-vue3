<template>
  ...
  <div
    class="modal fade"
    ref="newImportDistribusiKapalModalRef"
    id="kt_import_modal_distribusikapal"
    tabindex="0"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-850px">
      ...
      <div class="modal-content">
          ...
          <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Import Data Distribusi Kapal</h2>
                <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_import_modal_distribusikapal_scroll"
            >
              <!--begin::Input group-->
...
export default {
    ...
    methods: {
        async submit() {
            ...
            formData.append('file', this.distribusikapal.file);

            await axios.get('/sanctum/csrf-cookie')
            await axios.post('/api/distribusikapal/import',formData).then(response=>{
                  if(response.data['messageinput'] == 1){
                    Swal.fire({
                        ...
                        $('#kt_import_modal_distribusikapal').modal('hide');

                        this.distribusikapal.file = '';
                    });
                  }else{
                    Swal.fire({
                        text: response.data['message'],
        ...
        handleFileUpload(){
          this.distribusikapal.file = this.$refs.file.files[0];
        }
    }
}
</script>
