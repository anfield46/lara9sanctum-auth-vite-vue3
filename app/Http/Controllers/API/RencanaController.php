...
{
    /////////////////////////// master data
    public function loadrencana(Request $request, Core $devextreme) //dx grid
    {
        ...
        foreach ($data['datax'] as $d) {
            $datax1[] = array(
                ...
                'tahun' => $d->tahun,
                'rencana_pengurangan_emisi' => $d->rencana_pengurangan_emisi,
                'rencana_penambahan_emisi' => $d->rencana_penambahan_emisi,
            );
        }
    ...
    public function add(Request $request)
    {
        ...
        $programdekarbon = new ProgramDekarbon([
            ...
            'tahun' => $request->tahun,
            'rencana_pengurangan_emisi' => $request->rencana_pengurangan_emisi,
            'rencana_penambahan_emisi' => $request->rencana_penambahan_emisi,
